%% Plot Figure 3B-D
losses = xlsread("paper_results/learn_realizable/brnn_learnrealizable-allparams-longer-agn-1units-losses.csv");
final_outputs = xlsread("paper_results/learn_realizable/brnn_learnrealizable-allparams-longer-agn-finaloutputs.csv");
targets = xlsread("paper_results/learn_realizable/brnn_learnrealizable-allparams-longer-agn-targets.csv");
initial_outputs = xlsread("paper_results/learn_realizable/brnn_learnrealizable-allparams-longer-agn-initialoutputs.csv");

threshes = xlsread("paper_results/learn_realizable/brnn_learnrealizable-allparams-longer-agn-1units-threshoverlearning.csv");
kms = xlsread("paper_results/learn_realizable/brnn_learnrealizable-allparams-longer-agn-1units-kmoverlearning.csv");
ascks = xlsread("paper_results/learn_realizable/brnn_learnrealizable-allparams-longer-agn-1units-asckoverlearning.csv");
ascrs = xlsread("paper_results/learn_realizable/brnn_learnrealizable-allparams-longer-agn-1units-ascroverlearning.csv");
ascamps = xlsread("paper_results/learn_realizable/brnn_learnrealizable-allparams-longer-agn-1units-ascampoverlearning.csv");
...
set(gca,'FontSize', fontsize);
legend('FontName', 'helvetica', 'FontSize', fontsize, 'Location', 'best')ontSize', fontsize);