...
def main():
	...
	# quit()
	main_name = "smnist_rnn"#"brnn200_noncued_moreascs_diffinit"#"brnn200_sussillo8_batched_hisgmav_predrive_scaleasc_wtonly_agn_nodivstart"#lng_lngersim_uniformoffset_furthertrain"
	base_name = "figures/" + main_name#"figures_wkof_051621/" + main_name
	base_name_save = "traininfo/" + main_name#"traininfo_wkof_051621/" + main_name
	base_name_model = "models/" + main_name#"models_wkof_051621/" + main_name
	...
	# model.load_state_dict(torch.load("saved_models/models_wkof_051621/brnn200_sussillo8_batched_hisgmav_predrive_scaleasc_wtonly_agn_nodivstart.pt"))
	# Train model
	num_epochs = 5
	lr = 0.0025#0.0025#25#1#25
	reg_lambda = 1500
