...
def main():
        main_name = "3bit_longer"#"brnn200_noncued_moreascs_diffinit"#"brnn200_sussillo8_batched_hisgmav_predrive_scaleasc_wtonly_agn_nodivstart"#lng_lngersim_uniformoffset_furthertrain"
        on_server = True
        if on_server:
            base_name = main_name
