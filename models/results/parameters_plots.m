...
if strcmp(task, "smnist")
    ...
    mem_params = xlsread("results_wkof_080821/pattern-" + specname + "-0itr-membraneparams.csv");
    asc_params = xlsread("results_wkof_080821/pattern-" + specname + "-0itr-ascparams.csv");
    
    mem_params_init = xlsread("results_wkof_080821/pattern-" + specname + "-0itr-init-membraneparams.csv");
    asc_params_init = xlsread("results_wkof_080821/pattern-" + specname + "-0itr-init-ascparams.csv");
end
