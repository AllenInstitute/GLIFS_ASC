...
if strcmp(task, "smnist")
    ...
    data_1 = xlsread("results_wkof_080821/smnist-1-ablation-dropout-259units-ablated-accs.csv");
    data_2 = xlsread("results_wkof_080821/smnist-2-ablation-dropout-256units-ablated-accs.csv");
    data_3 = xlsread("results_wkof_080821/smnist-3-ablation-dropout-259units-ablated-accs.csv");
    data_4 = xlsread("results_wkof_080821/smnist-4-ablation-dropout-256units-ablated-accs.csv");
    data_5 = xlsread("results_wkof_080821/smnist-5-ablation-dropout-259units-ablated-accs.csv");
    data_6 = xlsread("results_wkof_080821/smnist-6-ablation-dropout-258units-ablated-accs.csv");
    data_7 = xlsread("results_wkof_080821/smnist-7-ablation-dropout-259units-ablated-accs.csv");
    data_8 = xlsread("results_wkof_080821/smnist-8-ablation-dropout-258units-ablated-accs.csv");
    data_9 = xlsread("results_wkof_080821/smnist-9-ablation-dropout-259units-ablated-accs.csv");
    data_10 = xlsread("results_wkof_080821/smnist-10-ablation-dropout-123units-ablated-accs.csv");
