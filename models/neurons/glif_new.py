...
class BNNC(nn.Module):
        def __init__(self, input_size, hidden_size, bias = True):
                ...
                #self.c_m_inv = 0.1
                #self.ln_c_m = Parameter(math.log(0.01) * torch.ones((1, hidden_size), dtype=torch.float), requires_grad=True)
                ...
                ln_k_m = math.log(0.05)#0.01)
                #ln_k_syn = 1#math.log(2)
                ln_asc_k = 1#math.log(10)#math.log(0.05)
